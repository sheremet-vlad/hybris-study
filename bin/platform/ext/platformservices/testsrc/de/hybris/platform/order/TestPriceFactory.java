...
public class TestPriceFactory
		implements PriceFactory, FindPriceStrategy, FindDiscountValuesStrategy, FindTaxValuesStrategy, ServiceLayerOnlyCalculationVerifier//, ForceFindStrategyWithCurrentPriceFactory
{
