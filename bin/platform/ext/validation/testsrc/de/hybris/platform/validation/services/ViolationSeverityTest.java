...
public class ViolationSeverityTest
{
	...
	public void testWarnTreshold() throws ClassNotFoundException
	{
		...
		final HybrisConstraintViolation violationWarn = new TestHybrisConstraintViolationImpl(buildViolationWithDescriptor(descriptorWarn));
		final HybrisConstraintViolation violationInfo = new TestHybrisConstraintViolationImpl(buildViolationWithDescriptor(descriptorInfo));
