...
public class DefaultExpandcustomerService implements ExpandcustomerService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultExpandcustomerService.class);
	...
	{
		return DefaultExpandcustomerService.class.getResourceAsStream("/expandcustomer/sap-hybris-platform.png");
	}
