...
public class DefaultCleanUpService implements CleanUpService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCleanUpService.class);
	...
	{
		return DefaultCleanUpService.class.getResourceAsStream("/cleanUp/sap-hybris-platform.png");
	}
