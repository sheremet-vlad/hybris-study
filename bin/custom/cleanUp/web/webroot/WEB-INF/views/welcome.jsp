...
<html>
<head>
    <title>Welcome to cleanUp</title>
    <link rel="stylesheet" href="<c:url value="/static/cleanUp-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "cleanUp" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/cleanUp-items.xml</b> - here you can model your items</li>
            <li><b>resources/cleanUp-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/cleanUp-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/cleanUp-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/cleanUp-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
